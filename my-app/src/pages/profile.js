  ...
  const ProfilePage = () => {
    ...
    <Box align="center" marginTop={isMobile ? '6rem' : '0'} paddingLeft={3} paddingRight={3}>
           ...
           <Flex direction="column" align="center" mt={20}>
                <Avatar size="xl" name="John Doe" src="/avatar.jpg" />
    ...
    <Box p={4}>
      ...
      <Button onClick={handleToggleEmail} mb={4}>
        {isEmailVisible ? 'Hide Email' : 'Show Email'}
      </Button>

      <Collapse in={isEmailVisible} animateOpacity>
        <Box>
          {/* <Text fontWeight="bold">Email:</Text> */}
          <Text fontWeight="bold" color="teal">john.doe@example.com</Text>
        </Box>
      </Collapse>
