...
export async function getCustomerCameraList(customerId, username, langflag) {
  ...
  <soap12:Header>
      ...
      <soap12:Body>
      <GetCustomerCameraList xmlns="http://tempuri.org/">
        <customerid>${customerId}</customerid>
        <username>${username}</username>
        <langflag>${langflag}</langflag>
      </GetCustomerCameraList>
      </soap12:Body>
      </soap12:Envelope>
      `;
...
async function extractCameraList(xmlResponse) {
  ...
  const getCustomerCameraListResponse = body.GetCustomerCameraListResponse;
  const cameraListResult = getCustomerCameraListResponse.GetCustomerCameraListResult;
